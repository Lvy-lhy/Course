...
Usage:
    $ bash data/scripts/get_coco.sh --val --segments  # download COCO-segments val split (1G, 5000 images_for_test)
...
def run(
    ...
    name="exp_noAdd",  # save to project/name
    ...
    if not training:
        ...
        task = task if task in ("train", "val", "test") else "val"  # path to train/val/test images_for_test
...
def parse_opt():
    ...
    parser.add_argument("--name", default="exp_noAdd", help="save to project/name")
