...
def parse_opt(known=False):
    ...
    #模型配置文件路径
    parser.add_argument("--cfg", type=str, default=ROOT/'models/myyolov5s.yaml', help="model.yaml path")
    #数据集配置文件路径
    parser.add_argument("--data", type=str, default=ROOT / "Maskdata/mydata.yaml", help="dataset.yaml path")
    #超参数文件路径
