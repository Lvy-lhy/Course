...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
    ...
    def load_mosaic(self, index):
        """Loads 1 image + 3 random images_for_test into a 4-image YOLOv5 mosaic, adjusting labels and segments accordingly."""
        labels4, segments4 = [], []
        s = self.img_size
    ...
    def collate_fn(batch):
        """Custom collation function for DataLoader, batches images_for_test, labels, paths, shapes, and segmentation masks."""
