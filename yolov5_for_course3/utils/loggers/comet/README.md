...
export COMET_MAX_IMAGE_UPLOADS=<number of allowed images_for_test to upload to Comet> # Controls how many total image predictions to log to Comet. Defaults to 100.
