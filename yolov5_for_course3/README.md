...
```bash
bash data/scripts/get_coco.sh --val --segments  # download COCO val segments split (780MB, 5000 images_for_test)
...
```bash
python segment/predict.py --weights yolov5m-seg.pt --source data/images_for_test/bus.jpg
```
...
```bash
bash data/scripts/get_imagenet.sh --val  # download ImageNet val split (6.3G, 50000 images_for_test)
...
```bash
python classify/predict.py --weights yolov5s-cls.pt --source data/images_for_test/bus.jpg
```
