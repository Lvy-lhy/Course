...
"""
Run YOLOv5 classification inference on images_for_test, videos, directories, globs, YouTube, webcam, streams, etc.
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT / "data/images_for_test", help="file/dir/URL/glob/screen/0(webcam)")
    ...
    parser.add_argument("--name", default="exp_noAdd", help="save results to project/name")
