...
def train(opt, device):
    ...
    if RANK in {-1, 0} and final_epoch:
        ...
        # Plot examples
        images, labels = (x[:25] for x in next(iter(testloader)))  # first 25 images_for_test and labels
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cache", type=str, nargs="?", const="ram", help='--cache images_for_test in "ram" (default) or "disk"')
