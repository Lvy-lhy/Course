...
if __name__ == "__main__":
    ...
    # Images
    imgs = [
        "data/images_for_test/zidane.jpg",  # filename
        Path("data/images_for_test/zidane.jpg"),  # Path
        "https://ultralytics.com/images/zidane.jpg",  # URI
        cv2.imread("data/images_for_test/bus.jpg")[:, :, ::-1],  # OpenCV
        Image.open("data/images_for_test/bus.jpg"),  # PIL
        np.zeros((320, 640, 3)),
    ]  # numpy
